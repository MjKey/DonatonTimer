# Таймер для донатона | Donathon Cooldown Timer
...
2. **Запустите таймер**
   - Дважды щелкните по файлу `DonathonTimer.exe`.
   - Proffit!
