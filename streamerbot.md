...
## ⚙️ Шаг 1. Настройка Streamer.bot
...
## ⚙️ Шаг 2. Подключение в Donaton Timer
...
2. В Streamer.bot убедитесь, что при трансляции события (Broadcasting) в объекте `data` вы отправляете поле `amount` (сумма доната) и, желательно, поле `user` или `name` (имя зрителя). Таймер автоматически подхватит эти данные.
