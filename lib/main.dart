...
class _MainScreenState extends State<MainScreen> {
  ...
  void _handleDonation(dynamic data) {
    ...
    if ((donationData['currency'] == 'RUB' and int(donationData['is_shown']) == 0) or 
    (int(donationData['is_shown']) == 0 and 
    (donationData['billing_system'] != 'TWITCH' or donationData['billing_system_type'] != 'REWARDS'))) {
