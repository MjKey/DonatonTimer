...
class _MainScreenState extends State<MainScreen> {
  ...
  void _handleDonation(dynamic data) {
    ...
    if ((donationData['currency'] == 'RUB' && donationData['is_shown'] == 0) || (donationData['is_shown'] == 0 && (donationData['billing_system'] != 'TWITCH' || donationData['billing_system_type'] != 'REWARDS'))) {
